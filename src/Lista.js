...
export default class Lista extends Component {
			...
			list:[
				{
					...
					rendimento:50,
					preparo:60,
					imagem:'https://amoradoceria.com.br/wp-content/uploads/2021/10/pao-de-mel-para-vender.jpg',
					ingredientes:[
				...
				},
				{
					...
					rendimento:16,
					preparo:45,
					imagem:'https://p2.trrsf.com/image/fget/cf/942/530/images.terra.com/2023/05/02/bolo-banana-fit-1jewk2nmi5ftv.jpg',
					ingredientes:[
	...
	clicou(item) {
		this.props.navigation.navigate('Receitas', { recipe: item });
	}
